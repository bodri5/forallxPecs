...
Hogyan tudjuk definiálni az igazságot egy atomi kijelentés esetén? Tekintsük például az $M$ kijelentést. Értelmezés nélkül nem mondhatjuk, hogy az $M$ igaz vagy hamis. Bármit jelenthet. Ha $M$ -mel azt jelöljük, hogy `A Hold a Föld körül kering', akkor $M$ igaz. Ha $M$ -mel azt jelöljük, hogy `A Hold egy hatalmas répa', akkor $M$ hamis.
...
Ráadásul a mód, ahogy eldöntjük, hogy $M$ igaz-e, függ attól, hogy $M$ mit jelent. Ha azt jelenti, hogy `Hétfő van,' akkor meg kell néznünk a naptárat. Ha azt jelenti, hogy `A Jupiter Io holdjának van jelentős vulkáni aktivitása,' akkor meg kell azt néznünk egy csillagászati szövegben--- és a csillagászok tudják ezt, hiszen küldtek műholdakat az Io megfigyelésére.
...
Az igazság logikus meghatározásának megadásával nem fogjuk tudni, hogy egy atomi kijelentés igaz vagy hamis. Ehelyett bemutatjuk az \emph{igazságérték-hozzárendelés}-t. Formálisan ez egy függvény lesz, ami megmondja nekünk az igaz értékét minden atomi kijeletésnek. Nevezzük ezt a függvényt `$a$'-nak (az angol assignment = feladat szó révén). Definiáljuk $a$-t minden \script{P} kijelentés betűjének, úgy mint
\begin{displaymath}
a(\script{P}) =
\left\{
	\begin{array}{ll}
