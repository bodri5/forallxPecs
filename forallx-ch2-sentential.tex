...
Ahhoz hogy helyesen tudjuk szimbolizálni ezt a mondatot, szükségünk van egy másik szimbólumra. Az `\end.`  jelet fogjuk használni a következőkben. 
...
A mondat két dolgot állít Barbaráról, tehát az angol nyelvben megengedhető hogy csak egyszer utaljunk Barbarára egy mondatban.
...
Most a mondat már fordítható úgy is fordítható mint $B\eand E$
