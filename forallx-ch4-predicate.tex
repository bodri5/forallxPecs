...
\problempart
\label{pr.QLcards}
Szimbólumkulcsokat használva fordítsuk le a magyar nyelvű mondatokat PL-re identitással. Az utolsó két mondat nem egyértelmű, fordítsa le őket mindkét módon.
\begin{ekey}
...
\item[Bx:] $x$ Farmer Brown földjén van.
\item[Hx:] $x$ egy ló.
...
\item Több, mint egy ló van Farmer Brown földjén.
\item 3 ló van Farmer Brown földjén.
\item Egy szárnyas teremtmény van Farmer Brown földjén; minden más teremtmény szárny nélküli.
\item A pegazus egy szárnyas ló.
\item Az állat Farmer Brown földjén nem egy ló.
\item A lónak Farmer Brown földjén nincsenek szárnyai.
\end{earg}
