...
\paragraph{Felszólítás} A parancsok hasonlóképpen, felszólításként fogalmazhatóak meg, mint a „Kellj fel!”, „Ülj egyenesen!”, stb. Nyelvtan órán ezeket felszólító mondatnak nevezzük. Habár neked lehet, hogy jobb egyenesen ülni, de az is lehet, hogy nem. Ezért ez a felszólítás se nem igaz, se nem hamis. Meg kell jegyezni azonban, hogy a parancsok nem mindig jelentenek felszólítást. „Tisztelni fogsz engem” vagy igaz, vagy hamis -- vagy fogod, vagy nem -- és éppen ezért a logikai felfogásban mondatnak számít.
...
\paragraph{Felkiáltás} „Jaj!” felkiáltó mondatnak nevezzük, de se nem igaz se nem hamis. A „Jaj, felsértettem a lábamat!” és a „Felsértettem a lábamat!” ugyan azt jelenti. A „jaj” kifejezés semmit sem segít abban, hogy eldöntsük ez igaz vagy sem.


\section*{Two ways that arguments can go wrong}
\section{Két eset, ahol az érvelés rossz lehet}
...
Képzeld el az esetet, amelyben esernyőt kellene magaddal vinned (lásd. ~\pageref{argRaining}. oldal). Ha a feljebb említett állítás (1) hamis, -- napos kint az idő -- akkor a helyzet nem ad rá okot, hogy esernyőt vigyél magaddal. Még ha esik is az eső, nem feltétlenül kell esernyőt vinned. Esetleg esőkabátot húzol vagy fedett utakon maradsz. Ezekben az esetekben a második állítás (2) hamis, mivel esernyő nélkül is kimehetsz anélkül, hogy megáznál.
...
Tételezzük fel, hogy mind a két állítás igaz. Nincsen esőkabátod és fedetlen utakon kell menned. Ebből az következik, hogy esernyőt kell vinned? Nem feltétlenül. Talán csak szeretsz esőben sétálni és elázni. Ebben az esetben, annak ellenére, hogy a feltételek igazak, az eredmény mégis hamis.
...
Bármi is legyen az érv, két oka lehet annak, hogy az hibás. Először, az állítások közül egy vagy akár több is hamis lehet. Az érvelés csak akkor adhat okot arra, hogy a kimenete valóban igaz, ha az állításait igaznak véljük. Másodszor, az állítások esetleg nem támasztják alá a kimenet hitelességét. Még ha az állítások igazak is, az érvelés gyenge lehet. A példa, ami éppen az előbb került megemlítésre, egyik esetben sem felelt meg ezeknek a kritériumoknak.
...
Amennyiben az érvelés gyenge az előbb említett második esetben, akkor a \emph{logikai formában} van a hiba: Tehát, az adott állítások nem feltétlenül igazolják annak eredményét. Számunkra elsősorban az érvelések logikai formája lesz a fontos.
...
Egy érv deduktívan \define{érvényes} akkor és csak is akkor, ha lehetetlen, hogy a feltevések igazak legyenek és a következtetések hamisak.
...
\section*{A logikai fogalmak összefoglalása}
\begin{itemize}
...
\item Egy érv (deduktív módon) akkor \define{érvényes}, ha lehetetlen, hogy az előfeltevés igaz legyen, és ugyanakkor a következtetés hamis; egyébként \define{érvénytelen}. 
\item A \define{tautology} is a sentence that must be true, as a matter of logic.
\item A \define{tautológia} olyan mondat, amelynek logikailag igaznak kell lennie.
\item A \define{contradiction} is a sentence that must be false, as a matter of logic.
\item Az \define{ellentmondás} vagy \define{kontradikció} egy mondat, amelynek logikailag  hamisnak kell lennie. 
\item A \define{contingent sentence} is neither a tautology nor a contradiction.
\item A \define{kontingens mondat} se nem tautológia, se nem ellentmondás.
\item Two sentences are \define{logically equivalent} if they necessarily have the same truth value.
\item Két mondat \define{logikailag ekvivalens}, hogyha szükségszerűen ugyanaz az igazságértékük. 
...
\item Egy mondatkészlet \define{konzisztens}, ha logikusan lehetséges, hogy a halmaz összes tagja egyszerre igaz legyen; egyébként \define{összeegyeztethetetlenek} (\define{inkonzisztensek}).
\end{itemize}
